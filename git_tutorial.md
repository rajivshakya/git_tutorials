...
Safely undoes committed changes.
...
Git creates NEW commit that reverses previous commit changes.
...
Copies specific commit from one branch to another.
...
Selected commit copied into current branch.
...
* hotfix commit needed in release branch

Instead of merging full branch:

* only required commit copied
...
Marks important project versions/releases.
...
These commands are heavily used in real-world DevOps and software engineering projects.
#########################################################################################
